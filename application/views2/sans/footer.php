...
<a href="https://www.paynow.co.zw/Transaction/Comments/1437"><img src="http://sans.co.zw/client_side/sans/images/verified_merchant.png"/></a>
    ...
    <script id="template-left" type="text/x-handlebars-template">
        ...
        <div class="small-12 large-12 medium-12 columns desc" align="left"><br/>
            <div class="small-12 large-12 medium-12 cloumns desc">{{item_name}} in <a href="<?php echo $url;?>catalogue/collection/{{collection}}">{{collection}}</a></div><br/>
            <div class="small-12 large-12 medium-12 cloumns desc">by <a href="<?php echo $url."designers/view/"?>{{designer}}">{{designer}}</a></div><br/></div><br/><br/>
        <div class="small-12 large-12 medium-12 columns desc" align="left"><br/>
        ${{price}} <a href="<?php echo $url;?>catalogue/{{sex this}}">{{sex this}}s clothing</a><br/>
            </div>
...
if(isset($nothing)){
 ...
 <?php  break;
    ...
    <div id="category">
        ...
        <script src="<?php echo $url?>client_side/sans/js/default.js"></script>
 <?php break;
}
}else{?>
