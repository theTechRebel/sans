<!-- JavaScript jQuery code from Bootply.com editor  -->
        ...
        <!-- shop theme js-->
        <script src="<?php echo $url?>client_side/sans/jquery.min.js" type="text/javascript"></script>
        <script src="<?php echo $url?>client_side/sans/bootstrap.min.js" type="text/javascript"></script>
